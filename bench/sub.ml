...
let slice_bytes = Slice_bytes.make bytes
...
let slice_bytes_sub () = Slice_bytes.sub slice_bytes ~off:8 ~len:8
let slice_bstr_sub () = Slice_bstr.sub slice ~off:8 ~len:8
...
let slice_bytes_sub = Staged.stage slice_bytes_sub
let slice_bstr_sub = Staged.stage slice_bstr_sub
...
let test4 = Test.make ~name:"Slice_bytes" slice_bytes_sub
let test5 = Test.make ~name:"Slice_bstr" slice_bstr_sub
...
let benchmark () =
  ...
  let tests = [ test0; test1; test2; test3; test4; test5 ] in
  let tests = Test.make_grouped ~name:"sub" ~fmt:"%s %s" tests in
